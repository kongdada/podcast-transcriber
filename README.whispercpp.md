...
本文件保留重构前的 `whisper.cpp` README 内容，供本仓库继续参考。
当前项目主页已经切换到播客工作流说明，请返回 [`README.md`](README.md)。
...
5. render `01_transcript.md` as merged dialogue turns instead of line-by-line segments
6. optionally apply show-specific profiles and OpenAI faithful cleanup
...
If you already know speaker names, replace generic `Speaker A/B` in the final transcript:
